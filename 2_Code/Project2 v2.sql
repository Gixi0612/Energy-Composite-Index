...
select * from alt_nuclear_use_2;
select * from alt_nuclear_good_ranking;
...
create table Energy_Efficiency_Index (SELECT *,
(Alt_nuclear_good_ranking + co2_emission_use_rank + energy_import_rank + energy_use_rank)/4 as Energy_Efficiency_Index
from 
...
order by Energy_Efficiency_Index desc);
...
CREATE TABLE GDP_EEI (select Energy_Efficiency_Index.economy,
Energy_Efficiency_Index.Alt_nuclear_good_ranking,
Energy_Efficiency_Index.co2_emission_use_rank,
Energy_Efficiency_Index.energy_import_rank,
Energy_Efficiency_Index.energy_use_rank,
Energy_Efficiency_Index.Energy_Efficiency_Index,
f.avg_gdp,
f.avg_gdp_rank
from energy_efficiency_index
left join F
on energy_efficiency_index.economy = F.economy);


select * from Energy_Efficiency_Index;
select * from gdp_eei;


# Drop table alt_nuclear_use_2
